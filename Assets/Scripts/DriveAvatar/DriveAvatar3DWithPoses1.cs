...
public class DriveAvatar3DWithPoses1 : MonoBehaviour
{
    ...
    // public Poses4 humanPose = new Poses4(new List<Vector3>(), new List<float>());
    public Poses4 humanPose = new Poses4(new List<Vector3>(), new List<float>()){
    ...
    // public Poses4 humanTPose = new Poses4(new List<Vector3>(), new List<float>());
    public Poses4 humanTPose = new Poses4(new List<Vector3>(), new List<float>()){
        Positions=new List<Vector3>(){
            new Vector3(0f, 0f, 0f),
            new Vector3(0f, 0f, 0f),
    ...
    List<Quaternion> GetHumanTPoseRotations(List<Vector3> vectorHumanTPose)
    {
        ...
        // construct the Poses4 class for calculating the human T-Pose rotations
        humanTPose = new Poses4(vectorHumanTPose, avatarBoneLengths);
    ...
    void RetargetTransform()
    {
        ...
        humanPose = new Poses4(vectorHumanKPs, avatarBoneLengths);
