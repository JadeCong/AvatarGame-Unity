...
public class DriveAvatar3D : MonoBehaviour
{
    ...
    {
        // convert the camera coordinate(xyz) to the unity coordinate(xyz): mapping(x:x, z:y, y:z)
    ...
    // SetTransform is called for updating the transform to humanoid player
